...
const prompts: Record<string,string> = {
 ...
 creation: "Implement createNote. Accept a non-empty title after trimming, with at most 80 JavaScript string code units. Reject invalid titles before any write. Persist the trimmed title and owner and return the created note. Preserve all other behavior.",
