...
> The US is consumed by `flow` (build phase) (the Lead executes it inline). Write this block as a self-contained, high-quality prompt — Commandment VIII applies to the plan itself.
