...
export const CLAUDE_DESIRED = {
  autoCompactWindow: CONTEXT_POLICY.defaultTokens,
  effortLevel: CONTEXT_POLICY.effort,
  modelSettings: { "claude-opus-5-5": { effortLevel: CONTEXT_POLICY.effort } },
} as const;
