/**
 * choose-skills ranking — pure, deterministic pre-filter.
 *
 ...
 * Snapshot: 2026-09-11. Keys migrated to approved names on 2026-09-13.
 * These are historical counts under the previous names, not new-name activation evidence.
 * A skill with no recorded invocation is simply absent.
 */
