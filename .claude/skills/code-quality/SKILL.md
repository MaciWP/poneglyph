...
| Script | Mode | Usage |
|--------|------|-------|
| `${CLAUDE_SKILL_DIR}/scripts/complexity-report.ts` | quality | `bun .claude/skills/code-quality/scripts/complexity-report.ts <path>` |
| `${CLAUDE_SKILL_DIR}/scripts/find-n-plus-one.ts` | performance | `bun .claude/skills/code-quality/scripts/find-n-plus-one.ts <path>` |
