...
# Decision Frameworks — the canon behind `compare-and-decide`
...
`compare-and-decide`: the quick 3-perspective scan, or the heavy adversarial stress-test
...
| **Type 2** | two-way | Changeable / reversible — you can reopen the door and walk back | "Can and should be made quickly by high-judgment individuals or small groups" → **exactly** `compare-and-decide`'s niche |
...
The `compare-and-decide` synthesis (Step 3) and the generated memo should follow the canonical ADR
...
For `compare-and-decide`: when the Critic perspective demands more analysis on a clearly reversible,
...
## How `compare-and-decide` uses this file
