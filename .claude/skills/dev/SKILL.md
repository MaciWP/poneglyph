...
| End-of-task shipping (commit / push / PR / "¿hago commit?") or AI authorship in a commit | CLAUDE.md §Git / PR — about to slip → drillme/AskUserQuestion, leave the tree dirty |
