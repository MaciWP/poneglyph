...
- [Phase 2 — Plan (tech-plan)](#phase-2-plan-tech-plan)
- [Phase 2.5 — TDD design (tdd-design)](#phase-25-tdd-design-tdd-design)
...
These question banks are the **canonical source**. Phase skills (`scope`, `tech-plan`, `tdd-design`, `build`, `critic`, `retro`) reference them — they do NOT duplicate the content in their own SKILL.md.
...
## Phase 2.5 — TDD design (tdd-design)
