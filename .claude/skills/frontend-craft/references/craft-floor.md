...
<!-- Adapted from Impeccable (Apache 2.0, pbakaus/impeccable), 2026-08-05. The
     original's design-hook machinery is not ported — apply these checks manually
     in the batched inspection round. -->
