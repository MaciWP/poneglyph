...
Not a `/harness-config` entrypoint (D7).

## 1. What / when

Bounded multi-worker orchestration. One HU stays inline. Fan-out only at ≥4 independent units (agent-routing).
...
| `/harness-config` workflow | **ausente** (D7) |
